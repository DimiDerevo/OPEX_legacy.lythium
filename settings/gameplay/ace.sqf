...
if (isClass (configFile >> "CfgPatches" >> "ace_maptools")) then {OPEX_friendly_mapTools append ["ACE_MapTools", "ACE_PlottingBoard"]};
if (isClass (configFile >> "CfgPatches" >> "ace_rangecard")) then {OPEX_friendly_rangeCards append ["ACE_RangeCard", "ACE_RangeTable_82mm", "ACE_artilleryTable"]};
...
if (isClass (configFile >> "CfgPatches" >> "ace_medical")) then
  {
    OPEX_medical_AI_IFAK = ["ACE_fieldDressing", "ACE_fieldDressing", "ACE_fieldDressing", "ACE_elasticBandage", "ACE_elasticBandage", "ACE_elasticBandage", "ACE_packingBandage", "ACE_packingBandage","kat_Painkiller", "ACE_tourniquet"];
    OPEX_medical_firstAidKit = "kat_IFAK";
    OPEX_medical_commonSupplies = ["ACE_morphine", "ACE_epinephrine", "ACE_tourniquet", "ACE_fieldDressing", "ACE_elasticBandage", "ACE_packingBandage", "kat_IFAK", "kat_chestSeal", "kat_ncdKit", "kat_Painkiller"];
    OPEX_medical_advancedSupplies = ["kat_atropine", "ACE_surgicalKit", "ACE_quikclot", "ACE_bloodIV_250", "ACE_bloodIV_500", "ACE_bloodIV", "ACE_plasmaIV_250", "ACE_plasmaIV_500",
     "ACE_plasmaIV", "ACE_salineIV_250", "ACE_salineIV_500", "ACE_salineIV", "ACE_bodyBag", "ACE_splint", "kat_AFAK", "kat_MFAK", "ACE_salineIV_250", "ACE_salineIV_500", "ACE_salineIV", "ACE_plasmaIV_250",
     "ACE_plasmaIV_500", "ACE_plasmaIV", "kat_IV_16", "kat_IV_16", "kat_IV_16", "kat_aatKit", "kat_Carbonate", "kat_nitroglycerin", "kat_stethoscope", "kat_basicDiagnostic", "kat_Painkiller", "kat_guedel", "kat_larynx",
     "kat_TXA", "kat_EACA", "ACE_morphine", "ACE_epinephrine", "ACE_tourniquet", "ACE_fieldDressing", "ACE_elasticBandage", "ACE_packingBandage", "kat_IFAK", "kat_chestSeal", "kat_ncdKit", "kat_Painkiller"];
