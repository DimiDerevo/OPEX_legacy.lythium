...
// =========================================================================================================
	...
	private _markerPos = [(_crashPos select 0) + random [500, 1000, 1500] - random [500, 1000, 1500], (_crashPos select 1) + random [500, 1000, 1500] - random [500, 1000, 1500]];

	// MARKER AREA
	"TaskMarker_A" setMarkerPos _markerPos;
	"TaskMarker_A" setMarkerShape "ellipse";
	"TaskMarker_A" setMarkerBrush "FDiagonal";
	"TaskMarker_A" setMarkerSize [random [500, 1000, 1500],random [500, 1000, 1500]];
