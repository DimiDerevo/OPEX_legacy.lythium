...
// =========================================================================================================
	...
	_tempGroup setBehaviourStrong "STEALTH";
	_tempGroup setCombatMode "green";

	private _pilot = [OPEX_friendly_side1, _tempGroup, [OPEX_friendly_aircraft_pilot], _pilotPos, OPEX_friendly_AIskill, false, "task"] call Gemini_fnc_createUnit;
	...
	_pilotGroup setCombatMode "GREEN";
	_pilotGroup setBehaviour "STEALTH";
	{(units _tempGroup) joinSilent _pilotGroup} forEach units _tempGroup;
	...
	_pilot setUnitCombatMode "GREEN";
	_pilot setBehaviour "STEALTH";
	0 = [_pilot, _pilotGroup] spawn {params ["_pilot", "_pilotGroup"]; sleep 10; _pilotGroup setCombatMode "GREEN"; _pilot setBehaviour "STEALTH"; removeBackpack _pilot; removeHeadgear _pilot;}; // For some reason it needs to be set after a delay to work
...
// =========================================================================================================
	...
	for "_i" from 1 to 5 do {[OPEX_enemy_side1, ["infantry", "infantry", "infantry", "infantry", "infantry", "motorized", "motorized"], (ceil (random 8)), _aircraftPos, [1000,2500], "attack", _aircraftPos, OPEX_enemy_AIskill, 75, "task"] call Gemini_fnc_spawnSquad};
