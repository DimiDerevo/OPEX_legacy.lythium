...
// =========================================================================================================
	...
	if (random 100 < 90) then {
		{
			[OPEX_enemy_motorizedVehicles, OPEX_enemy_side1, _x, _taskRadius / 2, [OPEX_enemy_units, selectRandom [2,3,4,5]], 15, "task"] call Gemini_fnc_spawnVehicle;
			[OPEX_enemy_side1, ["infantry"], selectRandom [2,3,4,5], _x, _taskRadius / 2, "patrol", _x, OPEX_enemy_AIskill, 50, "task"] call Gemini_fnc_spawnSquad;
			if (random 100 > 90) then {[OPEX_enemy_side1, ["infantry"], selectRandom [2,3], _x, _taskRadius / 2, "talk", _x, OPEX_enemy_AIskill, 100, "task"] call Gemini_fnc_spawnSquad};
			if (random 100 > 90) then {[_x, _taskRadius / 2, random 12, OPEX_enemy_side1, OPEX_enemy_units, OPEX_enemy_AIskill, "task"] call Gemini_fnc_spawnUnitsStandingInside};
