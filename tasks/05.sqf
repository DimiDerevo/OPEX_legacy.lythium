...
// =========================================================================================================
	...
	for "_i" from 1 to random 3 do {[OPEX_enemy_side1, ["infantry"], selectRandom [3,5,7], _buildingPos, [100, 250], "patrol", _buildingPos, OPEX_enemy_AIskill, 50, "task"] call Gemini_fnc_spawnSquad};
...
// =========================================================================================================
	...
	"TaskMarker_A" setMarkerSize _locationArea vectorMultiply [4, 4];
...
// =========================================================================================================
	...
	_reporter addMPEventHandler ["MPkilled", {[] spawn {reporter = nil; publicVariable "reporter"; sleep random [15, 30, 60]; [] spawn Gemini_fnc_taskFailed}}];
