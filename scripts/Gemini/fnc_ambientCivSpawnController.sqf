...
while {true} do {
    ...
    if (OPEX_ambientSpawnCivHandlerLoop) then {
        ...
        OPEX_ambientCivilianManMax = ((50 max (_playerCount * 3)) min 250); publicVariable "OPEX_ambientCivilianManMax";
        OPEX_ambientCivilianCarsMax = ((5 max (_playerCount * 2)) min 15); publicVariable "OPEX_ambientCivilianCarsMax";
