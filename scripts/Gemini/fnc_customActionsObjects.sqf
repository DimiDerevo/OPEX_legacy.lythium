				...
				if ((((getObjectTextures _x) select 0) find "specialization") != -1) then
					{
						...
						_x setVariable ["R3F_LOG_disabled", true];
						_x enableSimulation false;
						[_x, _white + (localize "STR_action_trainingCheck") + "</t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa", "_target distance2D _this < 3", "_target distance2D _this < 3", {}, {}, 
							{
								if ([_caller] call ace_common_fnc_isMedic) then {hint localize "STR_hint_training_isMedic"};
								if ([_caller] call ace_common_fnc_isEngineer) then {hint localize "STR_hint_training_isEngineer"};
								if (_caller getUnitTrait "explosiveSpecialist") then {hint localize "STR_hint_training_isExplosiveSpecialist"};
								if (_caller getUnitTrait "UAVHacker") then {hint localize "STR_hint_training_isUAVHacker"};
								if (_caller getUnitTrait "interpret") then {hint localize "STR_hint_training_isInterpret"};
								if ((!([_caller] call ace_common_fnc_isMedic)) && (!([_caller] call ace_common_fnc_isEngineer)) && (!(_caller getUnitTrait "explosiveSpecialist")) && (!(_caller getUnitTrait "UAVHacker")) && (!(_caller getUnitTrait "interpret")))
									then {hint localize "STR_hint_training_none"}}, {}, ["medic"], 0.5, 10, false, false] call BIS_fnc_holdActionAdd;
						[_x, _white + format [localize "STR_action_trainingMedic", 5] + "</t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa",
							"(_target distance2D _this < 3) && !([_this] call ace_common_fnc_isMedic)", "(_target distance2D _this < 3) && !([_this] call ace_common_fnc_isMedic)", {hint localize "STR_hint_training"}, {}, {_this execVM "scripts\Gemini\fnc_training.sqf"}, {}, ["medic"], 10, 10, false, false] call BIS_fnc_holdActionAdd;
						[_x, _white + format [localize "STR_action_trainingEngineer", 5] + "</t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa",
							"(_target distance2D _this < 3) && !([_this] call ace_common_fnc_isEngineer)", "(_target distance2D _this < 3) && !([_this] call ace_common_fnc_isEngineer)", {hint localize "STR_hint_training"}, {}, {_this execVM "scripts\Gemini\fnc_training.sqf"}, {}, ["engineer"], 10, 10, false, false] call BIS_fnc_holdActionAdd;
						[_x, _white + format [localize "STR_action_trainingExplosive", 5] + "</t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa",
							"(_target distance2D _this < 3) && !(_this getUnitTrait 'explosiveSpecialist')", "(_target distance2D _this < 3) && !(_this getUnitTrait 'explosiveSpecialist')", {hint localize "STR_hint_training"}, {}, {_this execVM "scripts\Gemini\fnc_training.sqf"}, {}, ["explosiveSpecialist"], 10, 10, false, false] call BIS_fnc_holdActionAdd;
						[_x, _white + format [localize "STR_action_trainingDrone", 5] + "</t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa",
							"(_target distance2D _this < 3) && !(_this getUnitTrait 'UAVHacker')", "(_target distance2D _this < 3) && !(_this getUnitTrait 'UAVHacker')", {hint localize "STR_hint_training"}, {}, {_this execVM "scripts\Gemini\fnc_training.sqf"}, {}, ["UAVHacker"], 10, 10, false, false] call BIS_fnc_holdActionAdd;
						[_x, _white + format [localize "STR_action_trainingInterpret", 5] + "</t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_requestleadership_ca.paa",
							"(_target distance2D _this < 3) && !(_this getUnitTrait 'interpret')", "(_target distance2D _this < 3) && !(_this getUnitTrait 'interpret')", {hint localize "STR_hint_training"}, {}, {_this execVM "scripts\Gemini\fnc_training.sqf"}, {}, ["interpret"], 10, 10, false, false] call BIS_fnc_holdActionAdd;
					};
			};
		...
		case "Box_NATO_Equip_F" :
			{
				...
				[_x, _white + format [localize "STR_action_selfHeal", 5] + "</t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_revive_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_revive_ca.paa", "(_target distance2D _this < 3)", "(_target distance2D _this < 3)", {hint localize "STR_hint_healing"}, {}, {[_caller] call ace_medical_treatment_fnc_fullHealLocal}, {}, [], 10, 10, false, false] call BIS_fnc_holdActionAdd;
