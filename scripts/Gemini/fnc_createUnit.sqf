	...
	if (_unitSide == OPEX_enemy_side1) then
		{
			...
			_unit setSkill ["aimingAccuracy", random [0.2, 0.25 , 0.32]];
			_unit setSkill ["aimingSpeed", 0.1];
			_unit setSkill ["endurance", 1];
			_unit setSkill ["spotTime", 1];
			_unit setSkill ["courage", random [0.8, 0.9, 1]];
			_unit setSkill ["aimingShake", random [0.15, 0.35 , 0.5]];
	...
	if (_unitSide == OPEX_friendly_side1) then
		{
			...
			_unit setSkill ["aimingAccuracy", random [0.4, 0.55 , 0.8]];
			_unit setSkill ["aimingSpeed", 0.1];
			_unit setSkill ["endurance", 1];
			_unit setSkill ["spotTime", 1];
			_unit setSkill ["courage", random [0.5, 0.66, 0.8]];
			_unit setSkill ["aimingShake", random [0.4, 0.5 , 0.7]];
			_unit setSkill ["commanding", random [0.4, 0.6, 0.9]];
			_unit setSkill ["spotDistance", random [0.5, 0.6 , 0.8]];
			_unit setSkill ["reloadSpeed", random [0.4, 0.55 , 0.6]];
		};
