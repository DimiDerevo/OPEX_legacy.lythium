...
private _mainFunction =
	{
		...
		if (count OPEX_playingPlayers <= 9) then {_maxBivouacs = 1};
		...
		if (_lightSourcePos isEqualTo [0,0,0]) exitWith {OPEX_ambientEnemyBivouacs = OPEX_ambientEnemyBivouacs - 1; publicVariable "OPEX_ambientEnemyBivouacs";};
