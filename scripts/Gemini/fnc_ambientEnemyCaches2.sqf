...
if (_cratePos isEqualTo [0,0,0]) exitWith {};
...
if (OPEX_debug) then {
	...
	[[format ["OPEX_debugMarker_ambient_%1", random 100000], getPosATL _crate, "ICON", "mil_warning", [0.8, 0.8], 0, "Solid", "ColorRed", 1, "CACHE"], "zeus", "distance"] spawn Gemini_fnc_createMarker2;
};