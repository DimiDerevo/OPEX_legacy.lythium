...
// =========================================================================================================
	...
	private _speciality = "";
	if (_training == "medic") then {_unit setVariable ["ACE_isEngineer", 0]; _unit setUnitTrait ["explosiveSpecialist", false]; _unit setUnitTrait ["UAVHacker", false]; _unit setUnitTrait ["medic", true]; _unit setVariable ["ACE_medical_medicClass", 1]; _unit setUnitTrait ["interpret", false, true]; _speciality = localize "STR_hint_trainingMedic"};
	if (_training == "engineer") then {_unit setUnitTrait ["medic", false]; _unit setVariable ["ACE_medical_medicClass", 0]; _unit setUnitTrait ["explosiveSpecialist", false]; _unit setUnitTrait ["UAVHacker", false]; _unit setVariable ["ACE_isEngineer", 1]; _unit setUnitTrait ["interpret", false, true]; _speciality = localize "STR_hint_trainingEngineer"};
	if (_training == "explosiveSpecialist") then {_unit setUnitTrait ["medic", false]; _unit setVariable ["ACE_medical_medicClass", 0]; _unit setVariable ["ACE_isEngineer", 0]; _unit setUnitTrait ["UAVHacker", false]; _unit setUnitTrait ["explosiveSpecialist", true]; _unit setUnitTrait ["interpret", false, true]; _speciality = localize "STR_hint_trainingExplosive"};
	if (_training == "UAVHacker") then {_unit setUnitTrait ["medic", false]; _unit setVariable ["ACE_medical_medicClass", 0]; _unit setVariable ["ACE_isEngineer", 0]; _unit setUnitTrait ["explosiveSpecialist", false]; _unit setUnitTrait ["UAVHacker", true]; _unit setUnitTrait ["interpret", false, true]; _speciality = localize "STR_hint_trainingUAV"};
	if (_training == "interpret") then {_unit setUnitTrait ["medic", false]; _unit setVariable ["ACE_medical_medicClass", 0]; _unit setVariable ["ACE_isEngineer", 0]; _unit setUnitTrait ["explosiveSpecialist", false]; _unit setUnitTrait ["UAVHacker", false]; _unit setUnitTrait ["interpret", true, true]; _speciality = localize "STR_hint_trainingInterpret"};
