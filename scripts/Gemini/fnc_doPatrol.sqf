...
// 			diag_log text format ["[doPatrol.sqf called from: %5] Recieved center of [0,0,0] | args: [%1, %2, %3, %4]", _squad, _center, _radius, _surface, _fnc_scriptNameParent];
// 		};
// 	};
		...
		for "_i" from 1 to 5 do
			{
				...
				_wp setWaypointFormation (selectRandom ["column", "stag column"]);
