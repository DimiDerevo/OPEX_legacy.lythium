...
// ----------------------------------------------------------------------
	...
	[_unit] spawn {
		_unit = _this#0;
		for "_i" from 0 to random 12 do {_unit addItemToBackpack "ACE_fieldDressing"}; sleep 0.1;
		for "_i" from 0 to random 10 do {_unit addItemToBackpack "ACE_elasticBandage"}; sleep 0.1;
		for "_i" from 0 to random 12 do {_unit addItemToBackpack "ACE_packingBandage"}; sleep 0.1;
		for "_i" from 0 to random 8 do {_unit addItemToBackpack "ACE_quikclot"}; sleep 0.1;
		for "_i" from 0 to random 5 do {_unit addItemToBackpack "ACE_tourniquet"}; sleep 0.1;
		for "_i" from 0 to random 5 do {_unit addItemToBackpack "ACE_splint"}; sleep 0.1;

		for "_i" from 0 to random 15 do {_unit addItemToBackpack "kat_chestSeal"}; sleep 0.1;
		for "_i" from 0 to random 7 do {_unit addItemToBackpack "kat_ncdKit"}; sleep 0.1;
		for "_i" from 0 to random 3 do {_unit addItemToBackpack "kat_aatKit"}; sleep 0.1;
		for "_i" from 0 to random 5 do {_unit addItemToBackpack "kat_guedel"}; sleep 0.1;
		for "_i" from 0 to random 2 do {_unit addItemToBackpack "kat_larynx"}; sleep 0.1;
		for "_i" from 0 to random 2 do {_unit addItemToBackpack "kat_nasal"}; sleep 0.1;
		for "_i" from 0 to random 1 do {_unit addItemToBackpack "kat_suction"}; sleep 0.1;
		for "_i" from 0 to random 1 do {_unit addItemToBackpack "kat_stethoscope"}; sleep 0.1;

		for "_i" from 0 to random 15 do {_unit addItemToBackpack "kat_IV_16"}; sleep 0.1;
		for "_i" from 0 to random 3 do {_unit addItemToBackpack "kat_IO_FAST"}; sleep 0.1;
		for "_i" from 0 to random 4 do {_unit addItemToBackpack "ACE_salineIV_500"}; sleep 0.1;
		for "_i" from 0 to random 2 do {_unit addItemToBackpack "ACE_plasmaIV_500"}; sleep 0.1;

		for "_i" from 0 to random 2 do {_unit addItemToBackpack "kat_Painkiller"}; sleep 0.1;
		for "_i" from 0 to random 6 do {_unit addItemToBackpack "ACE_morphine"}; sleep 0.1;
		for "_i" from 0 to random 3 do {_unit addItemToBackpack "ACE_epinephrine"}; sleep 0.1;
		for "_i" from 0 to random 5 do {_unit addItemToBackpack "kat_epinephrineIV"}; sleep 0.1;
		for "_i" from 0 to random 3 do {_unit addItemToBackpack "kat_TXA"}; sleep 0.1;
		for "_i" from 0 to random 2 do {_unit addItemToBackpack "kat_Carbonate"}; sleep 0.1;
	};
